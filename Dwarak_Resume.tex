...
\resheading{{Skills}}
	\begin{description}
		\item[Technologies:] { \footnotesize C/C++ with a little exposure to Ruby and Java
		}
...
\item[{Blind Source Separation using STFT and Spatial Sparsity}] { \footnotesize An approach to solve the Cocktatil Party Problem - separate signals of distinct individuals by exploiting their Spatial Sparsity in frequency domain using Short Time Fourier Transform}

\item[{Comparison of NoSQL databases}] { \footnotesize Comparison of Mongo and CouchDB databases from a use case standpoint}
